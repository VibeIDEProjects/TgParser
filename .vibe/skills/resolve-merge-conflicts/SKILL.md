...
The helper script lives next to this skill at `scripts/extract_conflict_context.py`. The examples below assume the skill is installed at `.claude/skills/resolve-merge-conflicts/`. Adjust the script path if you've placed the skill elsewhere.
...
```bash
python3 .claude/skills/resolve-merge-conflicts/scripts/extract_conflict_context.py
```
...
```bash
python3 .claude/skills/resolve-merge-conflicts/scripts/extract_conflict_context.py --file path/to/file
```
...
```bash
python3 .claude/skills/resolve-merge-conflicts/scripts/extract_conflict_context.py --all
```

### JSON output

```bash
python3 .claude/skills/resolve-merge-conflicts/scripts/extract_conflict_context.py --file path/to/file --json
```
