---
name: update-skill
description: Create or update skills by generating, editing, or refining SKILL.md files. Use when authoring new skills or revising the structure, frontmatter, or guidance for existing ones.
---

# update-skill

This guide provides instructions for creating or updating skills. It covers the required structure, frontmatter, and best practices for skills.
...
- **name**: Kebab-case identifier (lowercase letters, numbers, hyphens only)
  - Example: `add-feature-flag`, `unit-tests`, `update-skill`
